...
For this specific game 3 smaller sub-levels were created of the labyrinth~\cite{fig:unity_levels}.
...
\begin{figure}[h]
    \centering
    \caption{4 stages of the labyrinth used for curriulum learning.}
    \label{fig:unity_levels}
\end{figure}

To train the agent the Proximal Policy Optimization (PPO) algorithm is used.
